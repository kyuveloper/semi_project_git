...
public class AdminInquiryStatus {
    ...
    public AdminInquiryStatus(Integer inqCode, String inqTitle, String inqClassi, String inqContents, Date registDate, Date updateDate, Integer userCode, Integer answerCode, String answerContents, Date answerRegistDate, Date answerUpdateDate) {
